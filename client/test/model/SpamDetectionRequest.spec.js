...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpamDetectionRequest', function() {
      beforeEach(function() {
        instance = new CloudmersiveSpamapiClient.SpamDetectionRequest();
      });

      it('should create an instance of SpamDetectionRequest', function() {
        // TODO: update the code to test SpamDetectionRequest
        expect(instance).to.be.a(CloudmersiveSpamapiClient.SpamDetectionRequest);
      });
